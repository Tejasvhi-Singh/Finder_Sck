...
void PreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->previewLoaded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->previewError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onPreviewLoaded(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PreviewWidget::*)(const QString & )>(_a, &PreviewWidget::previewLoaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PreviewWidget::*)(const QString & )>(_a, &PreviewWidget::previewError, 1))
            return;
    }
}
...
// SIGNAL 0
void PreviewWidget::previewLoaded(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void PreviewWidget::previewError(const QString & _t1)
{
